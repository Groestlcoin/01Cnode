...
var url = "http://localhost:" + config.get('Web.port');
	describe('/api/groestlcoind/getblock/:hash tests:', function(done){
		var route = "/api/groestlcoind/getblock/000000009b7262315dbf071787ad3656097b892abffd1f95a1a022f896f533fc";
